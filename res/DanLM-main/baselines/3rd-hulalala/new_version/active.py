...
def active( actionList, handcards, rank, numofplayers, mypos, remaincards):
    ...
    sorted_cards, single_actionlist, pair_actionlist, trips_actionlist, threepair_actionlist, threetwo_actionlist, twotrips_actionlist, straight_actionlist = getlist(
        handcards, rank)
