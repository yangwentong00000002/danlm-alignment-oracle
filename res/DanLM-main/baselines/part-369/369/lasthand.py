class lasthand(object):
    ...
    def getcolor(self,dict,cur,greaterPos):
        ...
        poker.insert(12,cur)
        # print(poker)
        print("这是后手dictgreat", dict[greaterPos[0]])
        for i in dict[greaterPos[0]][::2]:
            #eval(play_data['greaterAction'])[0]
            # print(dict[greaterPos[0]][::2])
...
# lh=lasthand
# msg={'type': 'act',
#  'handCards': ['H2', 'H2', 'C4', 'H5', 'H5', 'D5', 'D6', 'S7', 'S7', 'C7', 'C7', 'D7', 'S8', 'S8', 'C8', 'H9', 'CT', 'DT', 'SQ', 'CQ', 'DQ', 'DK', 'DA', 'HJ', 'CJ', 'DJ', 'SB'],
#  'publicInfo': [{'rest': 22,
...
# print(lasthand.hgetcard(lasthand.firstcard(hd,'2')[0],lasthand.firstcard(hd,'2')[1],'2'))
