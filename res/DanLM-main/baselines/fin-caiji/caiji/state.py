...
class State(object):
    ...
    def parse(self, msg):
        ...
        try:
            result = self.__parse_func[(self._stage, self._type)]()
            #self._stage = None
            #self._type = None
            self.initial()
            return result
    ...
    def notify_begin(self):
        ...
        return self._stage, self._type, self._handCards, self._myPos
    ...
    def notify_play(self):
        ...
        return self._stage, self._type, self._curPos, self._curAction
    ...
    def notify_tribute(self):
        ...
        return self._stage, self._type, self._result
    ...
    def notify_anti(self):
        ...
        return self._stage, self._type, self._antiNum, self._antiPos
    ...
    def notify_episode_over(self):
        ...
        '''
        return self._stage, self._type, self._order, self._curRank, self._restCards
    ...
    def notify_game_over(self):
        ...
        return self._stage, self._type, self._curTimes, self._settingTimes
    ...
    def notify_game_result(self):
        ...
        return self._stage, self._type, self._victoryNum, self._draws
    ...
    def act_play(self):
        ...
        return self._stage, self._type, self._handCards, self._actionList, self._selfRank, self._oppoRank, self._curRank, self._greaterPos, self._greaterAction
    ...
    def act_tribute(self):
        ...
        '''print("我方等级：{}， 对方等级：{}， 当前等级{}".format(self._selfRank, self._oppoRank, self._curRank))
        print("轮到自己进贡，可进贡的牌有: ")'''
        return self._stage, self._type, self._actionList, self._selfRank, self._oppoRank, self._curRank
    ...
    def act_back(self):
        ...
        '''print("我方等级：{}， 对方等级：{}， 当前等级{}".format(self._selfRank, self._oppoRank, self._curRank))
        print("轮到自己还贡，可还贡的牌有:")'''
        return self._stage, self._type, self._actionList
